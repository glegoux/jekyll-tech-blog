...
The important Requests for Comments (RFC) to understand Kerberos are [rfc4120](https://www.ietf.org/rfc/rfc4120.txt) and 
...
{% include content/image.html title="MIT Kerberos" src="kerberos-logo.jpg" %}
...
{% include content/google-drawing.html title="Kerberos authentication architecture" 
...
{% include content/google-drawing.html title=" Kerberos authentication workflow with LDAP" 
...
{% include content/google-drawing.html title="Kerberos/Docker icon" src="kerberos-docker-logo.png" %}

This servers cluster is deployed automatically with only one command. 

{% include content/google-drawing.html title="Kerberos architecture on docker for Kerberos/Docker project" 
