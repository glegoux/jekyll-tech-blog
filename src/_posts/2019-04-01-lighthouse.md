...
{% include content/image.html title="Logo of Lighthouse" src="lighthouse-logo.png" %}
...
{% include content/image.html title="Lighthouse scores by report category" src="scores.png" %}
...
{% include content/image.html title="Export, import and view Lighthouse report" src="export-import-view.jpg" %}

# Lighthouse architecture

The workflow of Lighthouse core is described by the following chart:

{% include content/image.html title="Architecture of Lighthouse Core" src="architecture.jpg" %}
...
{% include content/image.html title="Google Chrome, Chromium and Canary version" src="chrome-version.jpg" %}
...
You get this csv file **reports.csv**. Visualize with **matplotlib** library:
 ...
 {% include content/image.html title=" Charts of scores for a set of URLs" src="plot_scores.png" %}
